...
#     Request parameters:
#         - application_data: данные заполненной формы.
#     """

#     application_data = request.get_json()

#     if not application_data:
#         return jsonify({"error": "Отсутствуют данные заявки."}), 400

#     application = Applications(
#         application_status=False,
#         nomination_id=application_data["nomination_id"],
#     )

#     applications_fields = ApplicationsFields(
#         question_answer=application_data["question_answer"]
#     )

#     db.session.add(application)
#     db.session.add(applications_fields)
#     db.session.commit()

#     return jsonify({"message": "Заявка успешно создана."}), 201


# @applications_bp.route("/get_application", methods=["GET"])
# @jwt_required()
# def get_application():
#     """
#     Получение одной заявки по её id.

#     Request parameters:
#         - application_id: id необходимой заявки.
#     """
...
#                 "fields": application.applications_fields,
#                 "arithmetic_evaluations": application.arithmetic_evaluations,
#                 "rating_evaluations": application.rating_evaluations,
#                 "nomination_results": application.nomination_results,
#             }
#         ]
#     )
...
#     """
#     Получение всех заявок / всех заявок по номинации.
...
#     if nomination_id:
#         applications = Applications.query.filter(nomination_id == nomination_id).all()
#     else:
#         applications = Applications.query.all()

#     if not applications:
#         return jsonify({"error": "Заявки не найдены"}), 404
